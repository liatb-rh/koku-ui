...
const renderWithIntl = (sources: Source[], props: Partial<ComponentProps<typeof SourcesTable>> = {}) => {
  const defaultProps = {
    sources,
...
describe('SourcesTable', () => {
  ...
  it('hides Remove when showRemoveAction is false', async () => {
    const user = userEvent.setup();
    renderWithIntl(mockSources, { showRemoveAction: false });
